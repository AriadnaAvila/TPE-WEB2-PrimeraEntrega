...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2024 a las 19:15:55
...
--
-- Estructura de tabla para la tabla `tablainformacion`
--

CREATE TABLE `tablainformacion` (
...
--
-- Indices de la tabla `tablainformacion`
--
ALTER TABLE `tablainformacion`
...
--
-- AUTO_INCREMENT de la tabla `tablainformacion`
--
ALTER TABLE `tablainformacion`
...
--
ALTER TABLE `tablaproducto`
  ADD CONSTRAINT `tablaproducto_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `tablainformacion` (`id_informacion`);
COMMIT;

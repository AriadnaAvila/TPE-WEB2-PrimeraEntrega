...
class productsModel
{
    ...
    {
        // Eliminar la información relacionada en la tabla informacion
        $queryInfo = $this->db->prepare('DELETE FROM informacion WHERE id_producto = ?');
        $queryInfo->execute([$id_producto]);
